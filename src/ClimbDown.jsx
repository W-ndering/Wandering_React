                            ...
                            return (
                                <div
                                    className={[
                                        ...
                                        current.speaker && (hasLineBreak || isBigText) ? styles.upTextMulti : "" // 화자 O, 줄바꿈 O
                                    ].join(" ").trim()}
                                >
                                    {current.speaker && (
                                        <div className={styles.speaker}>{current.speaker}</div>
                                    )}
                                    <div className={`${styles.content} ${current.id === 7 ? styles.bigText : ""}`}>{displayedText}</div>
                                </div>
                            );
                        })()}
                    </div>
